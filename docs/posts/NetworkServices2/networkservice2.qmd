...
Question: _Let's search for the module "smtp_version", what's it's full module name?_
...
Question: _We've now got a good amount of information on the target system to move onto the next stage. Let's search for the module "smtp_enum", what's it's full module name?_
...
Question: _Let's search for and select the "mysql_schemadump" module. What's the module's full name?_
